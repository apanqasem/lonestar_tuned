...
)
{
	...
	//+----------------------------
	H_ERR(cudaMallocManaged((void **)&ex_cat_sml_d,	sizeof(vertex_t)*cat_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_mid_d,	sizeof(vertex_t)*cat_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_lrg_d,	sizeof(vertex_t)*cat_sz));
	gpu_bytes		+= (3*sizeof(vertex_t)*cat_sz);
	
	H_ERR(cudaMallocManaged((void **)&ex_q_sml_d,	sizeof(vertex_t)*vert_count));
	H_ERR(cudaMallocManaged((void **)&ex_q_mid_d,	sizeof(vertex_t)*vert_count));
	H_ERR(cudaMallocManaged((void **)&ex_q_lrg_d,	sizeof(vertex_t)*vert_count));
	...
	H_ERR(cudaMallocManaged((void **)&ex_cat_sml_off, sizeof(index_t)*off_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_mid_off, sizeof(index_t)*off_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_lrg_off, sizeof(index_t)*off_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_sml_sz, sizeof(index_t)*off_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_mid_sz, sizeof(index_t)*off_sz));
	H_ERR(cudaMallocManaged((void **)&ex_cat_lrg_sz, sizeof(index_t)*off_sz));
	gpu_bytes		+=	(sizeof(vertex_t)*off_sz*6);
	
	
	H_ERR(cudaMallocManaged((void **)&depth_d, 		sizeof(depth_t)*vert_count));
	H_ERR(cudaBindTexture(0,tex_depth,depth_d,sizeof(depth_t)*vert_count));

	H_ERR(cudaMallocManaged((void **)&adj_card_d, 	sizeof(index_t)*vert_count));
	H_ERR(cudaMallocManaged((void **)&strt_pos_d,	sizeof(index_t)*vert_count));
	...
	EDGES_C = edge_count;
	H_ERR(cudaMallocManaged((void **)&adj_list_d,sizeof(vertex_t)*edge_count));
	...
	H_ERR(cudaMallocManaged((void **)&tr_edges_c_d, 
